    ...
    async function fetchNews() {
        try {
            ...
            if (response.ok) {
                ...
                // Устанавливаем currentIndex так, чтобы самая актуальная новость оказалась первой
                currentIndex = 0; // Начнем с первой новости, которая теперь является самой актуальной
